                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <form method="post">
                                <a href="../lib/print/cetak_laporan.php?tgl_daftar=<?php echo $kat['tgl_daftar']; ?>&periode=<?= $kat['periode']; ?>">
                                <button type="button" class="btn btn-primary btn-sm waves-effect waves-light m-b-5"><i class="fa fa-print m-r-5"></i>Cetak</button></a>
                              </form>
                            </td>
                          </tr>
